...
const validationSchema: ZodType<ContactDetailsSchema> = z.object({
    ...
    permanent_address_country: z.string().min(1, { message: "Country required" }),
    permanent_address_region: z.string().optional(),
    permanent_address_state: z.string().min(1, { message: "State required" }),
    ...
    permanent_address_contact_number: z.string().min(1, { message: "Contact Number required" }),

    current_address_1: z.string().min(1, { message: "Current Address required" }),
    current_address_2: z.string().optional(),
    current_address_country: z.string().min(1, { message: "Country required" }),
    current_address_region: z.string().optional(),
    current_address_state: z.string().min(1, { message: "State required" }),
    ...
    current_address_contact_number: z.string().min(1, { message: "Contact Number required" }),
