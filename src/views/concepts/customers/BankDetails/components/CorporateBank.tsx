    ...
    return (
        <Card>
            ...
            <div className="grid md:grid-cols-2 gap-4">
                ...
                <FormItem
                    label="Bank Address"
                    invalid={Boolean(errors.bank_address)}
                    errorMessage={errors.bank_address?.message}
                >
                    <Controller
                        name="bank_address"
                        control={control}
                        defaultValue={data?.bank_address || ''}
                        render={({ field }) =>
                            <Input
                                type="text"
                                {...field}
                ...
                <FormItem
                    label="Branch Name"
                    invalid={Boolean(errors.branch_name)}
                    errorMessage={errors.branch_name?.message}
                >
                    <Controller
                        name="branch_name"
                        control={control}
                ...
                asterisk
                    label="Account #"
                    invalid={Boolean(errors.account_number)}
                ...
                asterisk
                    ...
                    invalid={Boolean(errors.account_holder_name)}
                ...
                <FormItem
                    label="Sort Code"
                    invalid={Boolean(errors.sort_code)}
                    errorMessage={errors.sort_code?.message}
                >
                    <Controller
                        name="sort_code"
                        control={control}
                ...
                <FormItem
                    label="SWIFT Code"
                    invalid={Boolean(errors.swift_code)}
                ...
                <FormItem
                    label="Bank URL"
                    invalid={Boolean(errors.bank_url)}
                    errorMessage={errors.bank_url?.message}
                >
                    <Controller
                        name="bank_url"
                        control={control}
                        defaultValue={data?.bank_url || ''}
                        render={({ field }) =>
                            <Input
                ...
                <FormItem
                    ...
                    invalid={Boolean(errors.country_of_bank)}
                    errorMessage={errors.country_of_bank?.message}
                >
                    <Controller
                        name="country_of_bank"
                        control={control}
                        defaultValue={data?.country_of_bank || ''}
                        render={({ field }) =>
                            <Input
                                type="text"
                                {...field}
                ...
                <FormItem
                    label="Bank Phone #"
                    invalid={Boolean(errors.bank_phone_number)}
                    errorMessage={errors.bank_phone_number?.message}
                >
                    <Controller
                        name="bank_phone_number"
                        control={control}
                        defaultValue={data?.bank_phone_number || ''}
                        render={({ field }) =>
                            <Input
                                type="text"
                                {...field}
                ...
                <FormItem
                    ...
                    invalid={Boolean(errors.salary_account)}
                    errorMessage={errors.salary_account?.message}
                >
                    <Controller
                        name="salary_account"
                        control={control}
                        defaultValue={data?.salary_account || ''}
                        render={({ field }) =>
                            <Input
                                type="text"
                                {...field}
                ...
                <FormItem
                    label="IFS No."
                    invalid={Boolean(errors.ifs_number)}
                    errorMessage={errors.ifs_number?.message}
                >
                    <Controller
                        name="ifs_number"
                        control={control}
                        defaultValue={data?.ifs_number || ''}
                        render={({ field }) =>
                            <Input
                                type="text"
                                {...field}
